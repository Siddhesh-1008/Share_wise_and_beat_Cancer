...
const FileUploadModal = ({
  ...
  return (
    /* WE ARE PASSING PROPS TO MODAL COMPONENT */
    <Modal
    ...
    >
      ...
      {/* 
        While the file is uploading, you see a spinning loading icon.
          After the file uploads successfully, you get a message that says it was successful.
          The name of the file is also displayed. 
          */}
      {uploading && (
        <IconProgress
          size={15}
