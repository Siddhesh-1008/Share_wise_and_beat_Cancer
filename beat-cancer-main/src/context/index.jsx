...
export const StateContextProvider = ({ children }) => {
  ...
  // Add this function to your StateContextProvider
const fetchKanbanRecordsByRecordName = useCallback(async (recordName) => {
  try {
    const result = await db
      .select()
      .from(Records)
      ...
      .execute();
    // Assuming you want to store these records in state
    setRecords(result);
    return result; // Optionally return the result
  } catch (error) {
    console.error("Error fetching Kanban records:", error);
  }
}, []);
  ...
  return (
    <StateContext.Provider
      value={{
        ...
        createUser,
        fetchUserRecords,
        fetchKanbanRecordsByRecordName,
        createRecord,
        currentUser,
        updateRecord,
      }}
